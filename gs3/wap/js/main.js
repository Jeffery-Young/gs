...
$(function() {
  ...
  function srollpage() {
    $("#thispage") && $("#thispage").length && $("#thispage").pagepiling({
      anchors: [
        "page1",
        "page2",
        "page3",
  ...
  function page11_resize() {
    ...
    // var $this_box_h = $('.pagebox11-swiper02').offset().top;
